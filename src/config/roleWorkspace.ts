...
export const MODULE_META: Record<AppModule, ModuleMeta> = {
  ...
  inventory: {
    ...
    description: 'Stok barang, serial aset, dan monitoring pengadaan.',
    navigationCategory: 'operasional',
    navigationOrder: 13,
...
export const ROLE_WORKSPACES: Record<KnownUserRole, RoleWorkspaceConfig> = {
  ...
  management: {
    ...
    shellMode: 'analytics',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'buat_tiket', 'request_pengadaan_barang', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan'],
    homeLabel: 'Dashboards',
  ...
  noc: {
    ...
    shellMode: 'compact',
    defaultModule: 'service_registrations',
    allowedModules: ['noc', 'buat_tiket', 'request_pppoe_noc', 'qc_instalasi_noc', 'service_registrations', 'request_rembes', 'network_map', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  lead_tech: {
    ...
    allowedModules: ['panel_kepala_teknisi', 'lead_tech', 'request_pengadaan_barang', 'validasi_registrasi', 'survey_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  finance: {
    ...
    shellMode: 'compact',
    defaultModule: 'service_registrations',
    allowedModules: ['finance', 'pelanggan', 'penagihan', 'request_pengadaan_barang', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan', 'service_registrations', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  inventory: {
    ...
    allowedModules: ['inventory', 'request_pengadaan_barang', 'retur_gudang_perangkat', 'request_gudang_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
