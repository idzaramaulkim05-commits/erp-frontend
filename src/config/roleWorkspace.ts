...
const MODULE_ROUTE_FALLBACK_MAP: Record<AppModule, string> = {
  ...
  router_management: '/app/routers',
  olt_monitoring: '/app/olts',
  odp_management: '/app/odps',
  paket_internet: '/app/pakets',
  master_wilayah: '/app/master-wilayah',
  datasheet_360: '/app/datasheet',
  sync_check: '/app/sync-check',
  billing_invoices: '/app/invoices',
  package_requests: '/app/package-requests',
  warehouse_management: '/app/warehouse',
  comprehensive_tickets: '/app/tickets',
  settings_isp: '/app/settings',
...
export const MODULE_META: Record<AppModule, ModuleMeta> = {
  ...
  performa_karyawan: {
    ...
    navigationCategory: 'dashboards',
    navigationOrder: 4,
    searchPlaceholder: 'Cari nama karyawan, email, divisi, atau skor KPI...',
    quickAction: null,
    viewFormats: ['grid', 'table'],
  },
  pengaturan_profil: {
    id: 'pengaturan_profil',
    label: 'Pengaturan Profil',
    description: 'Kelola informasi profil, kontak, ganti kata sandi, dan avatar foto pengguna.',
    navigationCategory: 'administrasi',
    navigationOrder: 8,
    quickAction: null,
    viewFormats: ['grid'],
  ...
  router_management: {
    id: 'router_management',
    label: 'Router & Telemetri',
    description: 'Manajemen router MikroTik, bandwidth traffic realtime, SFP backbone, dan isolir PPPoE.',
    navigationCategory: 'infrastruktur',
    navigationOrder: 2,
    searchPlaceholder: 'Cari router, interface, atau user PPPoE...',
    quickAction: null,
    viewFormats: ['grid', 'table'],
  },
  olt_monitoring: {
    id: 'olt_monitoring',
    label: 'Monitoring OLT & ONU',
    description: 'Monitoring perangkat OLT GPON/EPON, daya optik PON, dan tabel status redaman ONU.',
    navigationCategory: 'infrastruktur',
    navigationOrder: 3,
    searchPlaceholder: 'Cari OLT, port PON, serial number ONU, atau nama pelanggan...',
    quickAction: null,
    viewFormats: ['grid', 'table'],
  },
  odp_management: {
    ...
    description: 'Pemetaan titik ODP, kapasitas port splitter, status gangguan, dan impor KMZ.',
    navigationCategory: 'infrastruktur',
    navigationOrder: 4,
    searchPlaceholder: 'Cari nama ODP, kode, atau status gangguan...',
    quickAction: null,
    viewFormats: ['map', 'table', 'grid'],
  },
  paket_internet: {
    id: 'paket_internet',
    label: 'Paket Internet',
    description: 'Master paket layanan internet, tarif bulanan, dan binding profil MikroTik.',
    navigationCategory: 'administrasi',
    navigationOrder: 9,
    searchPlaceholder: 'Cari nama paket atau profil MikroTik...',
    quickAction: null,
    viewFormats: ['grid', 'table'],
  },
  master_wilayah: {
    ...
    description: 'Hierarki wilayah administratif BPS Lampung dan generator ID Pelanggan unik.',
    navigationCategory: 'administrasi',
    navigationOrder: 10,
    searchPlaceholder: 'Cari provinsi, kabupaten, kecamatan, atau desa...',
    quickAction: null,
    viewFormats: ['table', 'grid'],
  },
  datasheet_360: {
    ...
    description: 'Master pelanggan 360°, galeri foto 5 sudut server lokal, riwayat tiket & tagihan.',
    navigationCategory: 'operasional',
    navigationOrder: 3,
    searchPlaceholder: 'Cari username PPPoE, nama, telepon, NIK, atau ODP...',
    quickAction: 'new_customer',
    viewFormats: ['table', 'grid'],
  },
  sync_check: {
    ...
    description: 'Matriks audit silang 3-arah antara MikroTik, Database Lokal, dan Google Sheets.',
    navigationCategory: 'administrasi',
    navigationOrder: 11,
    searchPlaceholder: 'Cari user discrepansi atau perbedaan status...',
    quickAction: null,
    viewFormats: ['table'],
  },
  billing_invoices: {
    id: 'billing_invoices',
    label: 'Invoicing & Penagihan',
    description: 'Tagihan bulanan, pembayaran tunggal & massal, cetak kwitansi, dan auto-isolir.',
    navigationCategory: 'keuangan',
    navigationOrder: 1,
    searchPlaceholder: 'Cari nomor invoice, nama pelanggan, atau status pembayaran...',
    quickAction: null,
    viewFormats: ['table', 'grid'],
  },
  package_requests: {
    id: 'package_requests',
    label: 'Pengajuan Ubah Paket',
    description: 'Alur persetujuan upgrade/downgrade paket pelanggan oleh divisi Finance.',
    navigationCategory: 'keuangan',
    navigationOrder: 2,
    searchPlaceholder: 'Cari pemohon ubah paket...',
    quickAction: null,
    viewFormats: ['table', 'grid'],
  },
  warehouse_management: {
    id: 'warehouse_management',
    label: 'Gudang & Retur Perangkat',
    description: 'Katalog stok bertingkat (Baru/Second/Rusak), approval pengadaan, dan retur cabut alat.',
    navigationCategory: 'operasional',
    navigationOrder: 16,
    searchPlaceholder: 'Cari item gudang, nomor request, atau retur...',
    quickAction: 'new_procurement',
    viewFormats: ['table', 'grid'],
  },
  comprehensive_tickets: {
    id: 'comprehensive_tickets',
    label: 'Tiket Terpadu & PSB',
    description: 'Tiket gangguan, pasang baru PSB, cabut alat dismantle, dan pemindai OCR ONT.',
    navigationCategory: 'operasional',
    navigationOrder: 2,
    searchPlaceholder: 'Cari nomor tiket, nama pelanggan, atau status tiket...',
    quickAction: 'new_ticket',
    viewFormats: ['table', 'grid', 'kanban'],
  },
  settings_isp: {
    id: 'settings_isp',
    label: 'Pengaturan ISP & Notifikasi',
    description: 'Konfigurasi parameter ISP, router MikroTik, WhatsApp Gateway, dan Bot Telegram.',
    navigationCategory: 'administrasi',
    navigationOrder: 12,
    quickAction: null,
    viewFormats: ['grid'],
  ...
  activity_logs: {
    ...
    description: 'Audit trail user, stream log login PPPoE, dan telemetri log sistem MikroTik.',
    navigationCategory: 'administrasi',
    navigationOrder: 13,
    searchPlaceholder: 'Cari aksi log atau username pengguna...',
    quickAction: null,
    viewFormats: ['table'],
  },
};
...
const FALLBACK_ROLE_WORKSPACE: RoleWorkspaceConfig = {
  ...
  allowedModules: ['dashboard', 'pengaturan_profil'],
...
export const ROLE_WORKSPACES: Record<KnownUserRole, RoleWorkspaceConfig> = {
  ...
  sales: {
    ...
    allowedModules: ['service_registrations', 'registrasi_pelanggan_baru', 'buat_tiket', 'request_rembes', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  management: {
    ...
    subtitle: 'Analitik bisnis, approval manajemen, performa tim, dan monitoring kinerja.',
    shellMode: 'analytics',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'performa_karyawan', 'buat_tiket', 'stok_barang', 'inventory_pop', 'request_pengadaan_barang', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  helpdesk: {
    ...
    allowedModules: ['helpdesk', 'buat_tiket', 'registrasi_pelanggan_baru', 'validasi_registrasi', 'request_rembes', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  noc: {
    ...
    shellMode: 'compact',
    defaultModule: 'service_registrations',
    allowedModules: ['noc', 'buat_tiket', 'request_pppoe_noc', 'qc_instalasi_noc', 'service_registrations', 'inventory_pop', 'request_rembes', 'network_map', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  lead_tech: {
    ...
    allowedModules: ['panel_kepala_teknisi', 'lead_tech', 'stok_barang', 'inventory_pop', 'request_pengadaan_barang', 'validasi_registrasi', 'survey_instalasi', 'request_rembes', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  field_tech: {
    ...
    allowedModules: ['panel_teknisi_lapangan', 'pengerjaan_instalasi_lapangan', 'field_tech', 'inventory_pop', 'request_rembes', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  finance: {
    ...
    shellMode: 'compact',
    defaultModule: 'service_registrations',
    allowedModules: ['finance', 'pelanggan', 'penagihan', 'stok_barang', 'request_pengadaan_barang', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan', 'service_registrations', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
  ...
  inventory: {
    ...
    allowedModules: ['inventory', 'stok_barang', 'inventory_pop', 'request_pengadaan_barang', 'retur_gudang_perangkat', 'request_gudang_instalasi', 'request_rembes', 'kanban', 'pengaturan_profil'],
    homeLabel: 'Dashboards',
