...
export const ROLE_WORKSPACES: Record<KnownUserRole, RoleWorkspaceConfig> = {
  ...
  management: {
    ...
    shellMode: 'analytics',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'buat_tiket', 'stok_barang', 'request_pengadaan_barang', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan'],
    homeLabel: 'Dashboards',
  ...
  lead_tech: {
    ...
    allowedModules: ['panel_kepala_teknisi', 'lead_tech', 'stok_barang', 'request_pengadaan_barang', 'validasi_registrasi', 'survey_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  inventory: {
    ...
    allowedModules: ['inventory', 'stok_barang', 'request_pengadaan_barang', 'retur_gudang_perangkat', 'request_gudang_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
