...
export const ROLE_WORKSPACES: Record<KnownUserRole, RoleWorkspaceConfig> = {
  ...
  management: {
    ...
    shellMode: 'analytics',
    defaultModule: 'dashboard',
    allowedModules: ['dashboard', 'buat_tiket', 'request_rembes', 'approval_rembes_finance', 'laporan_keuangan'],
    homeLabel: 'Dashboards',
  ...
  lead_tech: {
    ...
    allowedModules: ['panel_kepala_teknisi', 'lead_tech', 'validasi_registrasi', 'survey_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  inventory: {
    ...
    allowedModules: ['inventory', 'retur_gudang_perangkat', 'request_gudang_instalasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
