...
export const ROLE_WORKSPACES: Record<KnownUserRole, RoleWorkspaceConfig> = {
  ...
  sales: {
    ...
    allowedModules: ['service_registrations', 'registrasi_pelanggan_baru', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
  ...
  helpdesk: {
    ...
    allowedModules: ['helpdesk', 'registrasi_pelanggan_baru', 'validasi_registrasi', 'request_rembes', 'kanban'],
    homeLabel: 'Dashboards',
